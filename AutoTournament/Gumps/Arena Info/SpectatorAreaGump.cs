...
{
	public class SpectatorAreaGump : Gump
	{
		ArenaControl m_Control;
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			{
                m_Control.RemoveSpectatorArea(info.ButtonID - 100, from);

                sender.Mobile.CloseGump(typeof(SpectatorAreaGump));

                sender.Mobile.SendGump(new SpectatorAreaGump(m_Control));
			}
		}
