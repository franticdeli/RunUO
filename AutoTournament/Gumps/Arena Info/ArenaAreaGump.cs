...
{
	public class ArenaAreaGump : Gump
	{
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			{
				m_Control.RemoveArenaArea( info.ButtonID - 100, from );

                sender.Mobile.CloseGump(typeof(ArenaAreaGump));

				sender.Mobile.SendGump( new ArenaAreaGump( m_Control ) );
			}
		}
